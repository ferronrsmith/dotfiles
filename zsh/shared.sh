...
# zshrc plugins
plugins=(rvm ack jq ag hub docker httpie ps shutdown virtualbox docker-dev docker-workspace git git-extras colored-man git-prompt git-hubflow last-working-dir mvn extract vagrant colorize git-ignore)
